...
if (
  ...
  $DR = $_POST['DR'];
  $ST = $_POST['ST'];
$queryt="INSERT INTO carte_sim(ICCID, Operateur, Date_Reception, Date_Suspension, Statut)
VALUES
  ('$IC','$OP','$DR','','$ST')";
		...
		<div id="content">
		   ...
		   <div class="top-navbar">
		     ...
		     <div class="xp-breadcrumbbar text-center">
                <h4 class="page-title">BASE SIM</h4>               
            </div>
          ...
          <div class="table-title">
            <div class="row">
              <div class="col-sm-6 p-0 d-flex justify-content-lg-start justify-content-center">
                <h2 class="ml-lg-2">SIM CARD</h2>
              </div>
              <div class="col-sm-6 p-0 d-flex justify-content-lg-end justify-content-center">
                <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal">
                  <i class="material-icons">&#xE147;</i> <span>Add SIM'S</span></a>
...
$requete = "SELECT * FROM carte_sim WHERE ICCID LIKE '%$search%' OR Operateur LIKE '%$search%' OR Date_Reception LIKE '%$search%' OR Statut LIKE '%$search%'";
$resultat = mysqli_query($conn, $requete);
  if ($resultat && mysqli_num_rows($resultat) > 0) {
    while ($rows = mysqli_fetch_assoc($resultat)) {
        $ICCID = $rows['ICCID'];
        $Operateur = $rows['Operateur'];
    ...
    <div class="modal-content">
      <form method="POST" action="#">
        <div class="modal-header">
          <h4 class="modal-title">Ajouter un carte sim</h4>
