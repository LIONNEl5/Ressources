...
if (
  ...
  $DR=$_POST['DR']; 
  $ST=$_POST['ST']; 
$queryt="INSERT INTO base_camera
VALUES
  ('$MO','$FA','$DR','$ST','$NS')";
    ...
    <div class="table-title">
      <div class="row">
        <div class="col-sm-6 p-0 d-flex justify-content-lg-start justify-content-center">
          <h2 class="ml-lg-2">CAMERA </h2>
        </div>
        <div class="col-sm-6 p-0 d-flex justify-content-lg-end justify-content-center">
          <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal">
		  <i class="material-icons">&#xE147;</i> <span>Add CAMERA</span></a>
...
$requete = "SELECT * FROM base_camera WHERE MODELE LIKE '%$search%' OR Fabricant LIKE '%$search%' OR NUM_SERIE LIKE '%$search%' OR Date_Reception LIKE '%$search%' OR Statut LIKE '%$search%'";
