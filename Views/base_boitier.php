...
$query="SELECT * FROM base_boitier";
...
if (
  ...
  $DS=$_POST['DS']; 
  $ST=$_POST['ST']; 
$queryt="INSERT INTO base_boitier
VALUES
  ('$MO','$TY','$IM','$NS','$DR','$DS','$ST')";
		...
		<div id="content">
		   ...
		   <div class="top-navbar">
		     ...
		     <div class="xp-breadcrumbbar text-center">
                <h4 class="page-title">BASE BOITIER</h4>               
            </div>
    ...
    <div class="table-title">
      <div class="row">
        <div class="col-sm-6 p-0 d-flex justify-content-lg-start justify-content-center">
          <h2 class="ml-lg-2">BOITIER </h2>
        </div>
        <div class="col-sm-6 p-0 d-flex justify-content-lg-end justify-content-center">
          <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal">
		  <i class="material-icons">&#xE147;</i> <span>Add BOITIER</span></a>
...
$requete = "SELECT * FROM base_boitier WHERE MODELE LIKE '%$search%' OR TYPE LIKE '%$search%' OR IMEI LIKE '%$search%' OR NUM_SERIE LIKE '%$search%' OR Date_Reception LIKE '%$search%' OR Statut LIKE '%$search%'";
$resultat = mysqli_query($conn, $requete);
  if ($resultat && mysqli_num_rows($resultat) > 0) {
    while ($rows = mysqli_fetch_assoc($resultat)) {
      ...
      $Date_Suspension=$rows['Date_Suspension']; 
      $Statut=$rows['Statut']; 
        echo '<tr>';
        echo '<td>
                <span class="custom-checkbox">
  ...
  <div class="modal-dialog">
    ...
    <form method="POST" action="#">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            <label>TYPE</label>
            <input type="text" class="form-control" name="TY" required>
          </div>
          <div class="form-group">
            <label>IMEI</label>
            <input type="text" class="form-control" name="IM" required>
          </div>
          <div class="form-group">
